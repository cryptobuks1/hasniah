...
if (!function_exists('plumbing_parts_action_skin_add_styles')) {
	...
	function plumbing_parts_action_skin_add_styles() {
		...
		wp_enqueue_style( 'plumbing_parts-skin-style', plumbing_parts_get_file_url('skin.css'), array(), null );
		if (file_exists(plumbing_parts_get_file_dir('skin.customizer.css')))
			wp_enqueue_style( 'plumbing_parts-skin-customizer-style', plumbing_parts_get_file_url('skin.customizer.css'), array(), null );
	}
}
...
.top_panel_inner_style_4 .menu_user_nav .dd-selected:hover, .menu_user_nav li.menu_user_currency .dd-selected:hover:after {
    color: '.$clr['accent2'].';
}
...
.menu_user_nav li.menu_user_login .wp-social-login-provider-list a,
.menu_user_nav li.menu_user_login .wp-social-login-provider-list a:hover{
...
if (!function_exists('plumbing_parts_action_skin_add_responsive')) {
	...
	function plumbing_parts_action_skin_add_responsive() {
		...
		if (file_exists(plumbing_parts_get_file_dir('skin.responsive'.($suffix).'.css'))) 
			wp_enqueue_style( 'theme-skin-responsive-style', plumbing_parts_get_file_url('skin.responsive'.($suffix).'.css'), array(), null );
	}
}
...
if (!function_exists('plumbing_parts_action_skin_add_scripts')) {
	...
	function plumbing_parts_action_skin_add_scripts() {
		if (file_exists(plumbing_parts_get_file_dir('skin.js')))
			wp_enqueue_script( 'theme-skin-script', plumbing_parts_get_file_url('skin.js'), array(), null );
		if (plumbing_parts_get_theme_option('show_theme_customizer') == 'yes' && file_exists(plumbing_parts_get_file_dir('skin.customizer.js')))
			wp_enqueue_script( 'theme-skin-customizer-script', plumbing_parts_get_file_url('skin.customizer.js'), array(), null );
	}
}
