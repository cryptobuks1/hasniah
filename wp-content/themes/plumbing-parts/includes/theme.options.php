...
//					"type" => "select"),
		...
		"footer_copyright" => array(
					...
					"allow_html" => true,
					"std" => "Plumbing Parts &copy; {Y} All Rights Reserved ",
					"rows" => "10",
					"type" => "editor"),
		...
		'info_other_1' => array(
            ...
            'privacy_text' => array(
                "title" => esc_html__("Text with Privacy Policy link", 'plumbing-parts'),
                "desc"  => wp_kses_data( __("Specify text with Privacy Policy link for the checkbox 'I agree ...'", 'plumbing-parts') ),
                "std"   => wp_kses_post( __( 'I agree that my submitted data is being collected and stored.', 'plumbing-parts') ),
                "type"  => "text"
            ),
