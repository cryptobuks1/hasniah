				...
				<div class="post_content isotope_item_content">
					...
					<div class="post_descr">
						...
						if ($post_data['post_protected']) {
							...
							if (!plumbing_parts_param_is_off($post_options['readmore']) && !in_array($post_data['post_format'], array('quote', 'link', 'chat', 'aside', 'status')) && function_exists('plumbing_parts_sc_button')) {
