    ...
    <div class="copyright_wrap copyright_style_<?php echo esc_attr($copyright_style); ?>  scheme_<?php echo esc_attr(plumbing_parts_get_custom_option('copyright_scheme')); ?>">
        <div class="copyright_wrap_inner">
            <div class="content_wrap">
                ...
                } else if ($copyright_style == 'socials' && function_exists('plumbing_parts_sc_socials')) {
                    plumbing_parts_show_layout(plumbing_parts_sc_socials(array('size'=>"tiny")));
                }
                ?>
                <div class="copyright_text"><?php plumbing_parts_show_layout(do_shortcode(str_replace(array('{{Y}}', '{Y}'), date('Y'), (plumbing_parts_get_custom_option('footer_copyright'))))); ?></div>
            </div>
        </div>
    </div>
<?php
