			...
			<div class="top_panel_middle" <?php plumbing_parts_show_layout($header_css); ?>>
				<div class="content_wrap">
					...
					<div class="menu_main_wrap">
						...
						<?php if (plumbing_parts_get_custom_option('show_search')=='yes' && function_exists('plumbing_parts_sc_search')) plumbing_parts_show_layout(plumbing_parts_sc_search(array('class'=>"top_panel_icon", 'state'=>"closed"))); ?>
					</div>
				</div>
			</div>
