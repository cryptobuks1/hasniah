...
if (in_array('contact_info', $top_panel_top_components) && ($contact_info=trim(plumbing_parts_get_custom_option('contact_info')))!='') {
	?>
	<div class="top_panel_top_contact_area"><?php plumbing_parts_show_layout($contact_info);?>
	</div>
	<?php
}
?>
...
if (in_array('open_hours', $top_panel_top_components) && ($open_hours=trim(plumbing_parts_get_custom_option('contact_open_hours')))!='') {
	?>
	<div class="top_panel_top_open_hours icon-clock"><?php plumbing_parts_show_layout($open_hours); ?></div>
	<?php
}
?>
...
if (in_array('phone', $top_panel_top_components) && ($phone=trim(plumbing_parts_get_custom_option('contact_phone')))!='') {
    ?>
    <div class="top_panel_top_phone"><a href="tel:<?php echo force_balance_tags($phone); ?>"><?php echo esc_html_e('Call us now: ', 'plumbing-parts') . force_balance_tags($phone); ?></a></div>
<?php
}
?>
...
<div class="top_panel_top_user_area">
	...
	if (in_array('socials', $top_panel_top_components) && plumbing_parts_get_custom_option('show_socials')=='yes') {
		...
		<div class="top_panel_top_socials">
			<?php if(function_exists('plumbing_parts_sc_socials')) plumbing_parts_show_layout(plumbing_parts_sc_socials(array('size'=>'tiny'))); ?>
		</div>
		<?php
	}
	...
	if (in_array('search', $top_panel_top_components) && plumbing_parts_get_custom_option('show_search')=='yes') {
		?>
		<div class="top_panel_top_search"><?php if(function_exists('plumbing_parts_sc_search')) plumbing_parts_show_layout(plumbing_parts_sc_search(array('state'=>'fixed'))); ?></div>
		<?php
	}
