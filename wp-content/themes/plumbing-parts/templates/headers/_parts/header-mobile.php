	...
	<div class="header_mobile">
		...
		<div class="side_wrap">
			...
			<div class="panel_top">
				...
				<?php 
				if ($header_options['search'] && plumbing_parts_get_custom_option('show_search')=='yes' && function_exists('plumbing_parts_sc_search'))
			...
			<div class="panel_middle">
				...
				if ($header_options['contact_address'] && (!empty($contact_address_1) || !empty($contact_address_2))) {
					?><div class="contact_field contact_address">
								...
								<span class="contact_label contact_address_1"><?php plumbing_parts_show_layout($contact_address_1); ?></span>
								<span class="contact_address_2"><?php plumbing_parts_show_layout($contact_address_2); ?></span>
							</div><?php
				}
				...
				if ($header_options['contact_phone_email'] && (!empty($contact_phone) || !empty($contact_email))) {
					?><div class="contact_field contact_phone">
                        <div>
                            ...
                            <span class="contact_label contact_phone"><a href="tel:<?php plumbing_parts_show_layout($contact_phone); ?>"><?php plumbing_parts_show_layout($contact_phone); ?></a></span>
                        </div>
                        <div>
                        <span class="contact_icon icon-mail"></span>
						<span class="contact_email"><a href="mailto:<?php plumbing_parts_show_layout($contact_email); ?>"><?php plumbing_parts_show_layout($contact_email); ?></a></span>
                        </div>
					</div><?php
				}
			...
			<div class="panel_bottom">
				<?php if ($header_options['socials'] && plumbing_parts_get_custom_option('show_socials')=='yes') { ?>
					<div class="contact_socials">
						<?php if(function_exists('plumbing_parts_sc_socials')) plumbing_parts_show_layout(plumbing_parts_sc_socials(array('size'=>'small'))); ?>
					</div>
				<?php } ?>
			</div>
		</div>
