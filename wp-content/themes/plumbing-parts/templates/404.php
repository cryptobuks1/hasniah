	...
	function plumbing_parts_template_404_output() {
		...
		<article class="post_item post_item_404">
			<div class="post_content">
				...
				<div class="page_search"><?php if(function_exists('plumbing_parts_sc_search')) plumbing_parts_show_layout(plumbing_parts_sc_search(array('state'=>'fixed', 'title'=>__('To search type and hit enter', 'plumbing-parts')))); ?></div>
			</div>
		</article>
		<?php
	}
