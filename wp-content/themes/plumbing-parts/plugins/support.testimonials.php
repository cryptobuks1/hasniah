...
if (!function_exists('plumbing_parts_testimonial_theme_setup')) {
	...
	function plumbing_parts_testimonial_theme_setup() {
		...
		add_filter('trx_utils_filter_override_options',		'plumbing_parts_testimonial_add_override_options');
		...
		// Meta box fields
		plumbing_parts_storage_set('testimonial_override_options', array(
...
// Add meta box
if (!function_exists('plumbing_parts_testimonial_add_override_options')) {
	//add_action('trx_utils_filter_override_options', 'plumbing_parts_testimonial_add_override_options');
	function plumbing_parts_testimonial_add_override_options() {
        $boxes[] = array_merge(plumbing_parts_storage_get('testimonial_override_options'), array('callback' => 'plumbing_parts_testimonial_show_override_options'));
        return $boxes;
	}
}

// Callback function to show fields in meta box
if (!function_exists('plumbing_parts_testimonial_show_override_options')) {
	function plumbing_parts_testimonial_show_override_options() {
		global $post;
		...
		$fields = plumbing_parts_storage_get_array('testimonial_override_options', 'fields');
		?>
...
if (!function_exists('plumbing_parts_testimonial_save_data')) {
	...
	function plumbing_parts_testimonial_save_data($post_id) {
		// verify nonce
		if ( !wp_verify_nonce( plumbing_parts_get_value_gp('override_options_testimonial_nonce'), admin_url() ) )
			return $post_id;
