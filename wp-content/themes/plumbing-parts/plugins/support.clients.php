...
if (!function_exists('plumbing_parts_clients_after_theme_setup')) {
	...
	function plumbing_parts_clients_after_theme_setup() {
		...
		if (plumbing_parts_storage_get_array('post_override_options', 'page')=='clients') {
			// Meta box fields
			plumbing_parts_storage_set_array('post_override_options', 'title', esc_html__('Client Options', 'plumbing-parts'));
