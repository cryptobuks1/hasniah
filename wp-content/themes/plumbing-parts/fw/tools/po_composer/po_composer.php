...
class plumbing_parts_po_composer {
	...
	function load_scripts() {
		if (isset($_REQUEST['page']) && $_REQUEST['page']=='po_composer') {
			wp_enqueue_style('po-composer-style', plumbing_parts_get_file_url('tools/po_composer/po_composer.css', array(), null));
		...
		if (isset($_REQUEST['page']) && $_REQUEST['page']=='po_composer') {
			...
			wp_enqueue_script('po-composer-script', plumbing_parts_get_file_url('tools/po_composer/po_composer.js', array('jquery'), null, true));
		}
	}
