...
class plumbing_parts_emailer {
	...
	function load_scripts() {
		if (isset($_REQUEST['page']) && $_REQUEST['page']=='trx_emailer') {
			wp_enqueue_style('trx-emailer-style', plumbing_parts_get_file_url('tools/emailer/emailer.css'), array(), null);
		...
		if (isset($_REQUEST['page']) && $_REQUEST['page']=='trx_emailer') {
			...
			wp_enqueue_script('trx-emailer-script', plumbing_parts_get_file_url('tools/emailer/emailer.js'), array('jquery'), null, true);
		}
	}
