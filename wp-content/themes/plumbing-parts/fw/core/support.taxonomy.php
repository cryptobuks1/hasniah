...
if (!function_exists('plumbing_parts_taxonomy_show_custom_fields')) {
	function plumbing_parts_taxonomy_show_custom_fields($tax_obj = null) {  
		...
		do_action('plumbing_parts_action_taxonomy_before_show_override_options', $tax_type, $tax_obj);
		...
		do_action('plumbing_parts_action_taxonomy_after_show_override_options', $tax_type, $tax_obj);
		?>
			</td>
		</tr>
		</table>
...
if (!function_exists('plumbing_parts_taxonomy_save_custom_fields')) {
	function plumbing_parts_taxonomy_save_custom_fields( $term_id=0 ) {  
		...
		// verify nonce
		if ( !wp_verify_nonce( plumbing_parts_get_value_gp('override_options_taxonomy_nonce'), admin_url() ) )
			return $term_id;
