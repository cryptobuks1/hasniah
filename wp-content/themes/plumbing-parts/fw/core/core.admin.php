...
if (is_admin()) {
	...
	if ( !function_exists( 'plumbing_parts_admin_load_scripts' ) ) {
		...
		function plumbing_parts_admin_load_scripts() {
			wp_enqueue_script( 'plumbing_parts-debug-script', plumbing_parts_get_file_url('js/core.debug.js'), array('jquery'), null, true );
			//if (plumbing_parts_options_is_used()) {
				wp_enqueue_style( 'plumbing_parts-admin-style', plumbing_parts_get_file_url('css/core.admin.css'), array(), null );
				wp_enqueue_script( 'plumbing_parts-admin-script', plumbing_parts_get_file_url('js/core.admin.js'), array('jquery'), null, true );
			//}
			if (plumbing_parts_strpos($_SERVER['REQUEST_URI'], 'widgets.php')!==false) {
				wp_enqueue_style( 'plumbing_parts-fontello-style', plumbing_parts_get_file_url('css/fontello-admin/css/fontello-admin.css'), array(), null );
				wp_enqueue_style( 'plumbing_parts-animations-style', plumbing_parts_get_file_url('css/fontello-admin/css/animation.css'), array(), null );
			}
		}
	}
	...
	if ( !function_exists( 'plumbing_parts_admin_prepare_scripts' ) ) {
		...
		function plumbing_parts_admin_prepare_scripts() {
			...
			<script>
                ...
                PLUMBING_PARTS_STORAGE['msg_importer_full_alert'] = "<?php
