...
if (!function_exists('plumbing_parts_post_theme_setup')) {
	...
	function plumbing_parts_post_theme_setup() {
		...
		if (plumbing_parts_storage_get_array('post_override_options', 'page') == 'post') {
			add_action('admin_enqueue_scripts', 						'plumbing_parts_post_admin_scripts');
			add_action('plumbing_parts_action_post_before_show_override_options',		'plumbing_parts_post_before_show_override_options', 10, 2);
			add_action('plumbing_parts_action_post_after_show_override_options',		'plumbing_parts_post_after_show_override_options', 10, 2);
...
if (!function_exists('plumbing_parts_post_after_theme_setup')) {
	...
	function plumbing_parts_post_after_theme_setup() {
		...
		if (plumbing_parts_storage_get_array('post_override_options', 'page') == 'post') {
			plumbing_parts_storage_set_array('post_override_options', 'fields', array(
...
if (!function_exists('plumbing_parts_post_before_show_override_options')) {
	//add_action('plumbing_parts_action_post_before_show_override_options', 'plumbing_parts_post_before_show_override_options', 10, 2);
	function plumbing_parts_post_before_show_override_options($post_type, $post_id) {
...
if (!function_exists('plumbing_parts_post_after_show_override_options')) {
	//add_action('plumbing_parts_action_post_after_show_override_options', 'plumbing_parts_post_after_show_override_options', 10, 2);
	function plumbing_parts_post_after_show_override_options($post_type, $post_id) {
		?>
		</div>
		<?php
	}
