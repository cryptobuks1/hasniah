...
if (!function_exists('plumbing_parts_sc_countdown')) {	
	function plumbing_parts_sc_countdown($atts, $content = null) {
		...
		wp_enqueue_script( 'plumbing_parts-jquery-plugin-script', plumbing_parts_get_file_url('js/countdown/jquery.plugin.js'), array('jquery'), null, true );
		wp_enqueue_script( 'plumbing_parts-countdown-script', plumbing_parts_get_file_url('js/countdown/jquery.countdown.js'), array('jquery'), null, true );
