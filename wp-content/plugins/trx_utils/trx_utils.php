...
if (!function_exists('trx_utils_setup_widgets')) {
    ...
    function trx_utils_setup_widgets() {
        ...
        // Include widgets
        require_once 'widgets/advert.php';
        require_once 'widgets/calendar.php';
        ...
        require_once 'widgets/recent_reviews.php';
        require_once 'widgets/socials.php';
        require_once 'widgets/top10.php';
        require_once 'widgets/twitter.php';
        require_once 'widgets/qrcode/qrcode.php';
    }
}
